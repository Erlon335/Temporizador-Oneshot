...
<h1 align="center"><img align="center" style="border-radius: 100%;" src="https://moodle.embarcatech.cepedi.org.br/pluginfile.php/1/theme_moove/logo/1733422525/Group%20658.png" width="300px;" alt=""><br><br>Temporizador OneShot</h1>

<h3 align="center">
    Temporizador de um disparo (One Shot) em Linguagem C 
</h3>
...
- O botão A(pushbutton) inicia o sistema.
...
```
$ git clone https://github.com/Erlon335/Temporizador-Oneshot.git
```
- Opção 2:
  - No repósitorio [Temporizador-Oneshot
](https://github.com/Erlon335/Temporizador-Oneshot.git) aperte o Botão <i><>code</i>
...
- Faça upload do aquivo <i>Oneshot.c</i>
...
[wokwi]
version = 1
firmware = 'build/Oneshot.hex'
elf = 'build/Oneshot.elf'
```
...
- Cole o arquivo <i>Oneshot.uf2</i> no armazenamento placa BitDog
<br>
...
Este projeto está sob a licença de Érlon Alves da Formação Básica em Software Embarcado da Embarcatech - Veja o arquivo <a href="https://github.com/Erlon335/Temporizador-Oneshot/blob/main/LICENSE">License.md<a/>
